...
Route::middleware(['auth', 'can:admin, App\Models\User'])->prefix('admin')->group(function () {
	...
	Route::get('/distributor-items/{distributor_id}', [DistributorItemAdminController::class, 'index'])->name('distributor-item.admin');
	...
	Route::get('/proposition/{id}', [PropositionAdminController::class, 'edit'])->name('proposition.edit');
	Route::put('/proposition', [PropositionAdminController::class, 'update'])->name('proposition.update');
	Route::put('/proposition/state/', [PropositionAdminController::class, 'updateState'])->name('proposition.update-state');
	Route::put('/proposition/items/{order_id}', [PropositionAdminController::class, 'updateItems'])->name('proposition.update-items');
